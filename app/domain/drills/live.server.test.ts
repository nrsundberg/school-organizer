...
import * as live from "./live.server";
...
// The state-machine module under test. Its functions take a Prisma client as
// an argument, so the FakePrisma stand-in below drives them without a real DB.
type LiveModule = typeof live;

...
export async function action({ params, context }: Route.ActionArgs) {
  ...
  // every other tenant click; doing it directly drops the single-threaded
  // DO from the critical write path.
  ...
  // Fire-and-forget broadcast — a broadcast failure must not 500 a click
